...
for iObj = 1:n
%     data(iObj).RatioMethod = 'normal';
%     data(iObj).CorrectionFactor = 1;
...
exportDir = 'C:\Users\jonesg5\Desktop\ACS temp\WinterDaysigramsNoCorrection';
...
for iObj = 1:numel(winterData)
    ...
    titleText = {'NO CORRECTION - American Cancer Society';['ID: ',thisObj.ID,', Session: ',thisObj.Session.Name,', Device SN: ',num2str(thisObj.SerialNumber)]};
